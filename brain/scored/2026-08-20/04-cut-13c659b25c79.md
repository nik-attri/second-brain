...
lane: capability
pain_signal: ''
reason: Saraev is the right person to learn packaging from, but this listing is all
  bio boilerplate with no extractable pricing or positioning move — skim the video
  only if you have idle time.
score: 4
scored_at: '2026-08-22T11:12:21.764671Z'
source: youtube
unlocks: ''
...
🖇️ Claude: https://claude.ai CRM: https://clickup.ai Video AI: https://higgsfield.ai/s/tWhJfK

If this is your first video: I'm Nick Saraev. I run LeftClick, an AI growth agency. We've done work for large brands you're likely familiar with, like Mr. Beast, Anthropic, OpenAI, and a few others.
...
Since starting my journey, I've grown a fair bit of capital. To diversify my income, at 30, I began investing in other businesses and advising companies on how to grow in the AI era. These include SaaS businesses,
